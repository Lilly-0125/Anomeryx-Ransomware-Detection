...
'''with open("trigger_alert.py", "w", encoding="utf-8") as f:
    f.write(content)

print(f"Written trigger_alert.py: {len(content)} characters")

with open("trigger_alert.py", "r", encoding="utf-8") as f:
    text = f.read()

try:
    compile(text, "trigger_alert.py", "exec")
